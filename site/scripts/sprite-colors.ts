...
(async () => {
  console.log(`Extracting colors for ${entries.length} Pokémon...`);

  const colors: Record<string, string> = {};
  for (const { canonName, spriteKey } of entries) {
  ...
  writeFileSync("src/data/spriteColors.ts", output);
  console.log(`\nWrote src/data/spriteColors.ts`);
})();
